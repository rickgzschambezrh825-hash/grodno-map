...
GRO_LANDMARKS = {
    "GCP_NOV_DOT86": {
        "name": "ДОТ №86 лейтенанта Кобылкина (д. Новики)",
        "lat": 53.8189,
        "lon": 23.6145,
        "sector": "68-й Укрепрайон / Сопоцкин",
        "description": "Орудийно-пулеметный полукапонир, железобетонный купол"
    },
    "GCP_NOV_SIVACHEV": {
