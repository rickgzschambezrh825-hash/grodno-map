    ...
    const NARA_AERIAL_SECTORS = [
      {
        ...
        desc: "Аэрофоторазведка Люфтваффе: Сопоцкин — Новики — ДОТ № 338 [ОДОТ № 38] — 86 ПО НКВД"
      },
      {
        id: "GX-2831-SD",
      ...
      },
      {
        ...
        desc: "Аэрофоторазведка переправ р. Неман, урочища Пышки и Солы (31-я армия, 3-й и 2-й гв. кавкорпуса)"
      }
    ];
